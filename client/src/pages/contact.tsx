...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Contact Us - NammaSahayak</title>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-neutral mb-8">
              Have questions or need assistance? We're here to help. Fill out the form below or use the alternative contact methods.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-neutral text-sm mt-2">Available Monday to Friday, 9am to 5pm</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-neutral text-sm mt-2">We'll respond within 24 hours</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-neutral">123 Main Street, Bangalore, Karnataka 560001</p>
              </div>
            </div>

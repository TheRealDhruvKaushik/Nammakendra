...
const DocumentUpload = ({
  ...
  const validateAndSetFile = (file: File) => {
    ...
    if (!validTypes.includes(file.type)) {
      toast({
        ...
        description:
          "Please upload a PDF, DOCX, TXT file, or an image (JPEG, PNG).",
        variant: "destructive",
      });
      return;
    }
    ...
    if (validImageTypes.includes(file.type)) {
      toast({
        ...
        description:
          "We'll use OCR to extract text from your image. This might take a moment.",
      });
    }
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append("pageType", "vidhana");
      ...
      toast({
        ...
        description:
          "There was a problem analyzing your document. Please try again.",
        variant: "destructive",
      });
    } finally {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardContent className="p-6">
        ...
        <p className="text-neutral mb-6">{t("document.description")}</p>

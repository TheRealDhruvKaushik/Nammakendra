          ...
          <nav className="md:order-2 w-full md:w-auto" aria-label="Main Navigation">
            <ul className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
              <li>
                <Link 
                  href="/" 
                  className={`block px-3 py-2 text-lg relative group ${location === "/" ? "text-white font-semibold" : "text-gray-300"}`}
              ...
              <li>
                <Link 
                  href="/namma-sahayak" 
                  className={`block px-3 py-2 text-lg relative group ${location === "/namma-sahayak" ? "text-white font-semibold" : "text-gray-300"}`}
              ...
              <li>
                <Link 
                  href="/namma-vidhana" 
                  className={`block px-3 py-2 text-lg relative group ${location === "/namma-vidhana" ? "text-white font-semibold" : "text-gray-300"}`}
              ...
              <li>
                <Link 
                  href="/contact" 
                  className={`block px-3 py-2 text-lg relative group ${location === "/contact" ? "text-white font-semibold" : "text-gray-300"}`}

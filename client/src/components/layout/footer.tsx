      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-blue-300">{t('nav.slogan')}</span>
              </div>
            </div>
            <p className="text-gray-200 mb-4">{t('footer.slogan')}</p>
            <div className="flex space-x-4">
              ...
              <a href="#" aria-label="X (Twitter)" className="text-gray-200 hover:text-white">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/namma-sahayak" className="text-gray-200 hover:text-white">{t('nav.sahayak')}</Link></li>
              <li><Link href="/namma-vidhana" className="text-gray-200 hover:text-white">{t('nav.vidhana')}</Link></li>
              <li><Link href="/accessibility" className="text-gray-200 hover:text-white">{t('footer.accessibility')}</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-200">
          ...
          <div className="mt-4">
            ...
            <Link href="/accessibility" className="text-gray-200 hover:text-white mx-2">{t('footer.accessibility')}</Link>
          </div>
        </div>
      </div>
    </footer>

      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">{t('our_mission')}</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/about" className="text-gray-300 hover:text-white">{t('about')}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/namma-sahayak" className="text-gray-300 hover:text-white">{t('namma_sahayak')}</Link></li>
              <li><Link href="/namma-vidhana" className="text-gray-300 hover:text-white">{t('namma_vidhana')}</Link></li>
              <li><Link href="/accessibility" className="text-gray-300 hover:text-white">{t('accessibility')}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span>123 Main Street, Bangalore, Karnataka</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mt-1 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="flex items-start">
                ...
                <span>info@nammasahayak.org</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
          ...
          <div className="mt-4">
            <Link href="/privacy-policy" className="text-gray-300 hover:text-white mx-2">{t('privacy_policy')}</Link>
            <Link href="/terms-of-service" className="text-gray-300 hover:text-white mx-2">{t('terms_of_service')}</Link>
            <Link href="/accessibility" className="text-gray-300 hover:text-white mx-2">{t('accessibility')}</Link>
          </div>
        </div>
      </div>
    </footer>
